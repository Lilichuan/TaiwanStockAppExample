...
class MyDataRepository @Inject constructor() {
    ...
    val stockAvgListData : MutableLiveData<List<StockAvgItem>> = MutableLiveData<List<StockAvgItem>>()

    val stockDayListData : MutableLiveData<List<StockDayItem>> = MutableLiveData<List<StockDayItem>>()
